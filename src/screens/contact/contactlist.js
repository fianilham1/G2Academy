...
class ContactList extends Component {
      ...
      fetch(`https://jsonplaceholder.typicode.com/comments?_limit=${limit}&_page=${page}`)
          ...
          .then(users => {
              ...
              if (page === 1)
                  ...
                  newData = [...this.state.users, ...userList]
    ...
    componentDidUpdate() {
      ...
      if (this.props.route.params?.itemAddData) {
        const newData = this.props.route.params?.itemAddData;
        this.addRow(newData)
      }
    }
    ...
    editRow = (newData) => {
      ...
      if(JSON.stringify(dataList[index]) !== JSON.stringify(newData)){
